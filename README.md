...
5. TECHNICAL ROADBLOCKS (WHAT I COULDN'T DO)
 ...
 - The Equip Override Bug: No matter what I tried, equipping any item assigned to the base lingeriegloves type automatically forces the game's internal manager to unequip the previously equipped lingeriegloves item. The game's native ItemManager / EquipmentSystem completely overrides our virtual subtypes.
 - Mesh Attachment Issue: I haven't successfully managed to intercept the equipment spawn pipeline to force specific item meshes to attach to the misc1–misc8 bone hooks instead of default hand/arm transforms.
